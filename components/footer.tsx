        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#management" className="text-muted-foreground hover:text-primary transition-colors">Our Management</a></li>
          ...
          >
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground">Monday - Friday: 9:00 AM - 6:00 PM</li>
              <li className="text-muted-foreground">Saturday: 10:00 AM - 4:00 PM</li>
